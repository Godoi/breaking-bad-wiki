context('Application Breaking Bad', () => {
    describe('Accessing the character details page', function () {
        it('successfully loads', function () {
            ...
            cy.location().should((loc) => {
                expect(loc.href).to.eq('http://localhost:4200/home/characters-detail/1')
            });
        });
    });
    describe('Validating character details', function () {
        let theCharacter = {}
        beforeEach(function () {
            cy.request('https://www.breakingbadapi.com/api/characters/1').as('character')
